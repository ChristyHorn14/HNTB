...
# output_directory = f"/Users/chrishornung/Desktop/HNTB Reboot/Outputs/PrelimEmails"
#output_directory = f"/Users/courtneythomas/Library/Mobile Documents/com~apple~CloudDocs/Residency/HNTB/HNTB_Chief/Outputs"
output_directory = f"/Users/courtneythomas/Library/Mobile Documents/com~apple~CloudDocs/Residency/HNTB/HNTB Reboot/tests/artifacts/Outputs"
...
file_path = f"/Users/courtneythomas/Library/Mobile Documents/com~apple~CloudDocs/Residency/HNTB/HNTB Reboot/tests/artifacts/hntb_dummy.xlsx"
sheet_name = 'Master Linked'
df = pd.read_excel(file_path, sheet_name=sheet_name)
print(df)
...
def generate_doc_for_attending(attending):
    ...
    # Extract the last name of the attending for the file name
    attending_name = attending.split()[-1]  # Assumes the last word in the attending's name is the last name
    ...
    # Save the document
    doc_path = os.path.join(output_directory, f"PrelimEmail_{attending}.docx")
    doc.save(doc_path)
...
for attending in unique_attending_values:
    generate_doc_for_attending(attending)

print(f"Documents saved in {output_directory}")
